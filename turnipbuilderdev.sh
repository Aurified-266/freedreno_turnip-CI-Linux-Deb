...
# Optimized for Mesa 26.X.X (Dev Branch) with Android NDK r27d.
# Update ndkver when necessary
...
id=turnip
name=💰Aurified.Turnip DEVEL$version Vulkan Driver
version=DEVEL$version
versionCode=$version_code
author=Aurified.Dev
description=💰Aurified.Turnip DEVEL is a development branch open-source Vulkan driver for Adreno GPUs based on Mesa $version. Debug and GPU Cache disabled.
minApi=29
EOF
...
create_backup_package(){
    ...
    # Define folder names
    backup_folder="Aurified_Turnip_DEVEL${version}.adpkg"
    magisk_backup_folder="Aurified_Turnip_Magisk_Module_DEVEL${version}"
...
{
  "schemaVersion": 1,
  "name": "💰Aurified.Turnip_DEVEL${version}",
  "description": "DEVEL${version} - Development branch Vulkan driver built from mesa repo; Debug and GPU Cache disabled",
  "author": "Aurified.Dev",
  "packageVersion": "DEVEL${version}",
  "vendor": "Mesa3D",
