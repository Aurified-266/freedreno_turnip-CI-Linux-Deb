...
#### Magisk Build:
- Ensure program is using Vulkan for best compatibility - try using a [VulkanSwitching](https://www.magiskmodule.com/hypervulkan-switcher/) Magisk Module - *soon to be forked*
